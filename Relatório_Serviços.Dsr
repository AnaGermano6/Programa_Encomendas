VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Relatório_Serviços 
   Bindings        =   "Relatório_Serviços.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   7755
   ClientLeft      =   120
   ClientTop       =   450
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   3405
         Object.Height          =   1695
         Picture         =   "Relatório_Serviços.dsx":0019
      EndProperty
   EndProperty
   SectionCode2    =   4
   ...
   EndProperty
End
Attribute VB_Name = "Relatório_Serviços"
